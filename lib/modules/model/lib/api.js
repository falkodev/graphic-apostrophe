const areaOptions = require('./area-options')
const widgetImagesOptions = require('./widget-images-options')
const minSizeOptions = require('./min-size-options')
const aspectRatioOptions = require('./aspect-ratio-options')
const limitOptions = require('./limit-options')
const sizeOptions = require('./size-options')
...
module.exports = {
   ...
   */
  extractOptions: function extractOptions(schema, field) {
